...
public class BasicKeyChain implements EncryptableKeyChain {
     ...
     * @throws org.zcashcoinj.wallet.UnreadableWalletException.BadPassword if the password doesn't seem to match
     * @throws org.zcashcoinj.wallet.UnreadableWalletException if the data structures are corrupted/inconsistent
     */
    ...
    public BasicKeyChain toEncrypted(KeyCrypter keyCrypter, KeyParameter aesKey) {
        ...
        try {
            ...
            for (ECKey key : hashToKeys.values()) {
                ...
                // (all zcashcoin controlled by that private key is lost forever).
