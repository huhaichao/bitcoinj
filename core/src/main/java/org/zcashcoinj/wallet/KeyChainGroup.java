...
public class KeyChainGroup implements KeyBag {
     ...
     * @see org.zcashcoinj.wallet.MarriedKeyChain
     */
     ...
     *
     * @throws org.zcashcoinj.crypto.KeyCrypterException Thrown if the wallet encryption fails for some reason,
     ...
     *
     * @throws org.zcashcoinj.crypto.KeyCrypterException Thrown if the wallet decryption fails for some reason, leaving the group unchanged.
     */
