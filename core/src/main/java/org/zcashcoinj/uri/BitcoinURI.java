...
import org.zcashcoinj.params.AbstractBitcoinNetParams;
 ...
 *
 * <ul>
 * <li>{@code zcashcoin:<address>}</li>
 * <li>{@code zcashcoin:<address>?<name1>=<value1>&<name2>=<value2>} with multiple
...
public class BitcoinURI {
     ...
     */
    @Deprecated
    public static final String BITCOIN_SCHEME = "zcashcoin";
    ...
    public BitcoinURI(@Nullable NetworkParameters params, String input) throws BitcoinURIParseException {
        ...
        // URI is formed as  zcashcoin:<address>?<query parameters>
        // blockchain.info generates URIs of non-BIP compliant form zcashcoin://address?....
        // We support both until Ben fixes his code.
        
        // Remove the zcashcoin scheme.
        // (Note: getSchemeSpecificPart() is not used as it unescapes the label and parse then fails.
        // For instance with : zcashcoin:129mVqKUmJ9uwPxKJBnNdABbuaaNfho4Ha?amount=0.06&label=Tom%20%26%20Jerry
        ...
        if (addressSplitTokens.length == 0)
            throw new BitcoinURIParseException("No data found after the zcashcoin: prefix");
