...
// This file shows how to use zcashcoinj from Javascript.
// To run, grab the zcashcoinj bundled JAR and then do something like this:
//
//   jjs -cp zcashcoinj-0.12-bundled.jar demo.js
//
...
//
//   jjs -cp zcashcoinj-0.12-bundled.jar
//
...
//
//   jjs -cp zcashcoinj-0.12-bundled.jar:$slf4fj demo.js
//
...
// Nashorn, unlike V8, is thread safe (because it runs on the JVM). And zcashcoinj is a threaded library. This means you
