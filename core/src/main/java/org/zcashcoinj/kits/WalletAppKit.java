...
import org.zcashcoinj.net.discovery.*;
import org.zcashcoinj.protocols.channels.*;
import org.zcashcoinj.store.*;
import org.zcashcoinj.wallet.*;
import org.slf4j.*;
...
/**
 * <p>Utility class that wraps the boilerplate needed to set up a new SPV zcashcoinj app. Instantiate it with a directory
 ...
 * It is to make it easier to fit zcashcoinj into GUI apps, which require a high degree of responsiveness on their main
 * thread which handles all the animation and user interaction. Even when blockingStart is false, initializing zcashcoinj
...
public class WalletAppKit extends AbstractIdleService {
     ...
     * block sync faster for new users - please refer to the documentation on the zcashcoinj website
