...
import org.zcashcoinj.core.listeners.NewBestBlockListener;
import org.zcashcoinj.core.*;
import org.zcashcoinj.net.discovery.DnsDiscovery;
...
public class BuildCheckpoints {
    ...
    public static void main(String[] args) throws Exception {
        ...
        // Configure zcashcoinj to fetch only headers, not save them to disk, connect to a local fully synced/validated
