...
import org.zcashcoinj.core.listeners.TransactionConfidenceEventListener;
...
import org.zcashcoinj.core.TransactionConfidence.ConfidenceType;
import org.zcashcoinj.crypto.*;
import org.zcashcoinj.script.Script;
import org.zcashcoinj.script.ScriptBuilder;
import org.zcashcoinj.script.ScriptChunk;
import org.zcashcoinj.script.ScriptPattern;
import org.zcashcoinj.signers.TransactionSigner;
import org.zcashcoinj.store.BlockStoreException;
import org.zcashcoinj.store.MemoryBlockStore;
import org.zcashcoinj.testing.*;
import org.zcashcoinj.utils.ExchangeRate;
import org.zcashcoinj.utils.Fiat;
import org.zcashcoinj.utils.Threading;
import org.zcashcoinj.wallet.Wallet.BalanceType;
import org.zcashcoinj.wallet.WalletTransaction.Pool;
...
import org.zcashcoinj.wallet.Protos.Wallet.EncryptionType;
...
import static org.zcashcoinj.core.Utils.HEX;
import static org.zcashcoinj.testing.FakeTxBuilder.*;
...
public class WalletTest extends TestWithWallet {
    ...
    public void doubleSpends() throws Exception {
        ...
        buf[43] = 0;  // Break the signature: zcashcoinj won't check in SPV mode and this is easier than other mutations.
    ...
    public void autosaveImmediate() throws Exception {
        ...
        File f = File.createTempFile("zcashcoinj-unit-test", null);
