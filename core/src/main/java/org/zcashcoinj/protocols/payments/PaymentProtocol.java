...
public class PaymentProtocol {
    ...
    public static final String MIMETYPE_PAYMENTREQUEST = "application/zcashcoin-paymentrequest";
    public static final String MIMETYPE_PAYMENT = "application/zcashcoin-payment";
    public static final String MIMETYPE_PAYMENTACK = "application/zcashcoin-paymentack";
