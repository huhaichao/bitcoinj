...
import org.zcashcoinj.crypto.TrustStoreLoader;
...
/** Takes a URL or zcashcoin URI and prints information about the payment request. */
public class PaymentProtocolTool {
    public static void main(String[] args) {
        if (args.length < 1) {
            System.err.println("Provide a zcashcoin URI or URL as the argument.");
            return;
        }
        dump(args[0]);
    }
