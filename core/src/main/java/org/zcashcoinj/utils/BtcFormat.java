...
package org.zcashcoinj.utils;

import org.zcashcoinj.utils.BtcAutoFormat.Style;
import static org.zcashcoinj.utils.BtcAutoFormat.Style.*;
 ...
 * {@code "฿"}.</p>
 *
 * <p>The denomination used when formatting will be either zcashcoin, millicoin
 ...
 * locale, a value of one zcashcoin might be formatted as {@code ฿1.00} where a value
 ...
 * {@code 1.0000 BTC}, or one zcashcoin, in millibitcoins, one shifts the decimal point
 ...
 * differently the same one-zcashcoin value:</p>
 *
 * <blockquote><pre>
...
public abstract class BtcFormat extends Format {
    ...
    /**
     * Formats a zcashcoin monetary value and returns an {@link AttributedCharacterIterator}.
    ...
    /**
     * Formats a zcashcoin value as a number and possibly a units indicator and appends the
    ...
    /**
     * Formats a zcashcoin value as a number and possibly a units indicator to a
    ...
    /**
     * Takes a zcashcoin monetary value that the client wants to format and returns the number of
    ...
    /**
     * Takes an object representing a zcashcoin quantity of any type the
