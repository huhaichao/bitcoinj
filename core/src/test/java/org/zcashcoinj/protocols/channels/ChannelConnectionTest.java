...
package org.zcashcoinj.protocols.channels;

import org.zcashcoinj.core.*;
import org.zcashcoinj.protocols.channels.PaymentChannelClient.VersionSelector;
import org.zcashcoinj.script.ScriptPattern;
import org.zcashcoinj.testing.TestWithWallet;
import org.zcashcoinj.utils.Threading;
import org.zcashcoinj.wallet.Wallet;
import org.zcashcoinj.wallet.WalletExtension;
import org.zcashcoinj.wallet.WalletFiles;
...
import org.zcashcoin.paymentchannel.Protos;
...
import static org.zcashcoinj.protocols.channels.PaymentChannelClient.VersionSelector.*;
import static org.zcashcoinj.protocols.channels.PaymentChannelCloseException.CloseReason;
import static org.zcashcoinj.testing.FakeTxBuilder.createFakeBlock;
import static org.zcashcoin.paymentchannel.Protos.TwoWayChannelMessage.MessageType;
...
public class ChannelConnectionTest extends TestWithWallet {
    ...
    private static Wallet roundTripClientWallet(Wallet wallet) throws Exception {
        ...
        org.zcashcoinj.wallet.Protos.Wallet proto = WalletProtobufSerializer.parseToProto(new ByteArrayInputStream(bos.toByteArray()));
