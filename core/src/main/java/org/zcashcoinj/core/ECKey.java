...
import org.zcashcoin.NativeSecp256k1;
import org.zcashcoin.NativeSecp256k1Util;
import org.zcashcoin.Secp256k1Context;
...
public class ECKey implements EncryptableItem {
     ...
     * @throws org.zcashcoinj.core.ECKey.MissingPrivateKeyException if the private key is missing or encrypted.
     */
    public byte[] toASN1() {
        try {
     ...
     * @throws org.zcashcoinj.core.ECKey.MissingPrivateKeyException if the private key bytes are missing/encrypted.
     */
