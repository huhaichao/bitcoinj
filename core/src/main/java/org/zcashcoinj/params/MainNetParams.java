...
public class MainNetParams extends AbstractBitcoinNetParams {
    ...
    public MainNetParams() {
        ...
        dnsSeeds = new String[] {
                "seed.zcashcoin.sipa.be",         // Pieter Wuille
                "dnsseed.bluematt.me",          // Matt Corallo
                "dnsseed.zcashcoin.dashjr.org",   // Luke Dashjr
                "seed.bitcoinstats.com",        // Chris Decker
                "seed.bitnodes.io",             // Addy Yeow
                "bitseed.xf2.org",              // Jeff Garzik
                "seed.zcashcoin.jonasschnelli.ch",// Jonas Schnelli
                "zcashcoin.bloqseeds.net",        // Bloq
        ...
        httpSeeds = new HttpDiscovery.Details[] {
                ...
                new HttpDiscovery.Details(
                        ...
                        URI.create("http://httpseed.zcashcoin.schildbach.de/peers")
                )
        };
