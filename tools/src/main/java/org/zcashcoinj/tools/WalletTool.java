...
package org.zcashcoinj.tools;

import org.zcashcoinj.crypto.*;
import org.zcashcoinj.params.MainNetParams;
import org.zcashcoinj.params.RegTestParams;
import org.zcashcoinj.params.TestNet3Params;
import org.zcashcoinj.protocols.payments.PaymentProtocol;
import org.zcashcoinj.protocols.payments.PaymentProtocolException;
import org.zcashcoinj.protocols.payments.PaymentSession;
import org.zcashcoinj.script.ScriptBuilder;
import org.zcashcoinj.script.ScriptException;
import org.zcashcoinj.script.ScriptPattern;
import org.zcashcoinj.store.*;
import org.zcashcoinj.uri.BitcoinURI;
import org.zcashcoinj.uri.BitcoinURIParseException;
import org.zcashcoinj.utils.BriefLogFormatter;
import org.zcashcoinj.wallet.DeterministicSeed;
import org.zcashcoinj.wallet.DeterministicUpgradeRequiredException;
import org.zcashcoinj.wallet.DeterministicUpgradeRequiresPassword;
...
import org.zcashcoinj.core.AbstractBlockChain;
import org.zcashcoinj.core.Address;
import org.zcashcoinj.core.AddressFormatException;
import org.zcashcoinj.core.Base58;
import org.zcashcoinj.core.Block;
import org.zcashcoinj.core.BlockChain;
import org.zcashcoinj.core.CheckpointManager;
import org.zcashcoinj.core.Coin;
import org.zcashcoinj.core.Context;
import org.zcashcoinj.core.DumpedPrivateKey;
import org.zcashcoinj.core.ECKey;
import org.zcashcoinj.core.FilteredBlock;
import org.zcashcoinj.core.FullPrunedBlockChain;
import org.zcashcoinj.core.InsufficientMoneyException;
import org.zcashcoinj.core.LegacyAddress;
import org.zcashcoinj.core.NetworkParameters;
import org.zcashcoinj.core.Peer;
import org.zcashcoinj.core.PeerAddress;
import org.zcashcoinj.core.PeerGroup;
import org.zcashcoinj.core.Sha256Hash;
import org.zcashcoinj.core.StoredBlock;
import org.zcashcoinj.core.Transaction;
import org.zcashcoinj.core.TransactionInput;
import org.zcashcoinj.core.TransactionOutput;
import org.zcashcoinj.core.Utils;
import org.zcashcoinj.core.VerificationException;
import org.zcashcoinj.core.listeners.BlocksDownloadedEventListener;
import org.zcashcoinj.core.listeners.DownloadProgressTracker;
import org.zcashcoinj.wallet.MarriedKeyChain;
import org.zcashcoinj.wallet.Protos;
import org.zcashcoinj.wallet.SendRequest;
import org.zcashcoinj.wallet.Wallet;
import org.zcashcoinj.wallet.WalletExtension;
import org.zcashcoinj.wallet.WalletProtobufSerializer;
import org.zcashcoinj.wallet.Wallet.BalanceType;
import org.zcashcoinj.wallet.listeners.WalletChangeEventListener;
import org.zcashcoinj.wallet.listeners.WalletCoinsReceivedEventListener;
import org.zcashcoinj.wallet.listeners.WalletCoinsSentEventListener;
import org.zcashcoinj.wallet.listeners.WalletReorganizeEventListener;
...
import static org.zcashcoinj.core.Coin.parseCoin;
...
public class WalletTool {
    ...
    private static org.zcashcoin.protocols.payments.Protos.PaymentRequest paymentRequest;
    ...
    private static void sendPaymentRequest(String location, boolean verifyPki) {
        if (location.startsWith("http") || location.startsWith("zcashcoin")) {
            try {
                ...
                System.err.println("Invalid zcashcoin uri: " + e.getMessage());
                System.exit(1);
            } catch (InterruptedException e) {
                // Ignore.
            } catch (ExecutionException e) {
            ...
            try {
                paymentRequest = org.zcashcoin.protocols.payments.Protos.PaymentRequest.newBuilder().mergeFrom(stream).build();
            } catch(IOException e) {
