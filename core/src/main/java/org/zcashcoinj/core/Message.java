...
public abstract class Message {
    ...
    /**
     * <p>Serialize this message to a byte array that conforms to the zcashcoin wire protocol.</p>
     *
    ...
    /**
     * Serialize this message to the provided OutputStream using the zcashcoin wire format.
     *
     * @param stream
     * @throws IOException
     */
